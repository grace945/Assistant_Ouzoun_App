...
class AppointmentToolModel {
  ...
  factory AppointmentToolModel.fromJson(Map<String, dynamic> json) =>
      _$AppointmentToolModelFromJson(json);
  Map<String, dynamic> toJson() => _$AppointmentToolModelToJson(this);
}
