...
class _NotificationsApi implements NotificationsApi {
  ...
  @override
  Future<Response<dynamic>> enableNotifications(
    EnableNotificationsModel body,
    String token,
  ) async {
  ...
  Future<List<GroupedNotificationResponse>> getCurrentUserNotifications(
    ...
    final _options = _setStreamType<List<GroupedNotificationResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'Notifications/CurrnetUserNotifications',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    late List<GroupedNotificationResponse> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                GroupedNotificationResponse.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
